...
.venv/bin/python run_uid_pipeline.py $INPUT_DIR $MODEL_NAME --uid_unit='word' --uid_level='sentence' --generate_counterfactual --output_dir $OUTPUT_DIR --output_name 'cf_word_sentence_uid.csv' --split_results --save_every=100
